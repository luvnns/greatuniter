classdef Device_OPMrubin
    properties (Constant)
        ...
        unitPrefixes = {'nW','uW','mW','W'} % if you want to change this constant, check autoSelectPrefix(obj)
    end
    properties
        name
        serialPort
    ...
    methods
        ...
        function obj = createWavelengthArray(obj)
            ...
            obj.wavelengthArray(1,ind) = currentWavelength;
        ...
        function obj = setWavelength(obj,newWavelength) %newWavelength in num
            newInd = find(obj.wavelengthArray == newWavelength);% or index - input to func?
